...
class MediaRepositoryPaginationTest {
    ...
    fun `pagination loop pageSize 20 until nextCursor null`() {
        ...
        val page1 = ArkivPage(items = listOf(sample("1"), sample("2")), nextCursor = "c1")
        val page2 = ArkivPage(items = listOf(sample("3")), nextCursor = null)
        ...
        do {
            ...
            // Verify pageSize 20 is used (sample would be 20, not dynamic)
        } while (cursor != null)
    ...
    private fun sample(id: String) = MediaItem(
